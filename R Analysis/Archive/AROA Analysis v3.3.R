...
friedmanControl("Control Median Ratings", "./Tests./Likert Ratings Control_Median", Data_ctrl, "Median.Rating", "runTests" = TRUE, "addJitter" = FALSE, type = "Wilcoxon")
...
friedmanTests("Confidence Ratings", "./Tests./Likert Ratings_Confidence", Data_avg, "Confidence", "runTests" = TRUE, "addJitter" = FALSE, followup = "Wilcox")
...
#World Preference
friedmanControl("Control Median - World Preference", "./Tests./Likert Ratings Control_WorldPref_Median", Data_ctrl_WorldPref, "Median.Rating", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Confidence - World Preference", "./Tests./Likert Ratings Control_WorldPref_Confidence", Data_ctrl_WorldPref, "Confidence", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Obstacle Location - World Preference", "./Tests./Likert Ratings Control_WorldPref_Obstacle Location", Data_ctrl_WorldPref, "Obstacle.location", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Obstacle Size  - World Preference", "./Tests./Likert Ratings Control_WorldPref_Obstacle Size", Data_ctrl_WorldPref, "Obstacle.size", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Awareness - World Preference", "./Tests./Likert Ratings Control_WorldPref_Awareness", Data_ctrl_WorldPref, "Awareness", "runTests" = FALSE, "addJitter" = FALSE)

friedmanTests("Median - World Preference", "./Tests./Likert Ratings_WorldPref_Median", Data_avg_WorldPref, "Median.Rating", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Confidence - World Preference", "./Tests./Likert Ratings_WorldPref_Confidence", Data_avg_WorldPref, "Confidence", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Obstacle Location - World Preference", "./Tests./Likert Ratings_WorldPref_Obstacle Location", Data_avg_WorldPref, "Obstacle.location", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Obstacle Size - World Preference", "./Tests./Likert Ratings_WorldPref_Obstacle Size", Data_avg_WorldPref, "Obstacle.size","runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Awareness - World Preference", "./Tests./Likert Ratings_WorldPref_Awareness", Data_avg_WorldPref, "Awareness", "runTests" = FALSE, "addJitter" = FALSE)

#Head Preference
friedmanControl("Control Median - Head Preference", "./Tests./Likert Ratings Control_HeadPref_Median", Data_ctrl_HeadPref, "Median.Rating", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Confidence - Head Preference", "./Tests./Likert Ratings Control_HeadPref_Confidence", Data_ctrl_HeadPref, "Confidence", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Obstacle Location - Head Preference", "./Tests./Likert Ratings Control_HeadPref_Obstacle Location", Data_ctrl_HeadPref, "Obstacle.location", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Obstacle Size  - Head Preference", "./Tests./Likert Ratings Control_HeadPref_Obstacle Size", Data_ctrl_HeadPref, "Obstacle.size", "runTests" = FALSE, "addJitter" = FALSE)
friedmanControl("Control Awareness - Head Preference", "./Tests./Likert Ratings Control_HeadPref_Awareness", Data_ctrl_HeadPref, "Awareness", "runTests" = FALSE, "addJitter" = FALSE)

friedmanTests("Median - Head Preference", "./Tests./Likert Ratings_HeadPref_Median", Data_avg_HeadPref, "Median.Rating", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Confidence - Head Preference", "./Tests./Likert Ratings_HeadPref_Confidence", Data_avg_HeadPref, "Confidence", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Obstacle Location - Head Preference", "./Tests./Likert Ratings_HeadPref_Obstacle Location", Data_avg_HeadPref, "Obstacle.location", "runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Obstacle Size - Head Preference", "./Tests./Likert Ratings_HeadPref_Obstacle Size", Data_avg_HeadPref, "Obstacle.size","runTests" = FALSE, "addJitter" = FALSE)
friedmanTests("Awareness - Head Preference", "./Tests./Likert Ratings_HeadPref_Awareness", Data_avg_HeadPref, "Awareness", "runTests" = FALSE, "addJitter" = FALSE)
