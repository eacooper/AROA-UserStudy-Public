...
%         end
        ...
        txt = {'START'};
        t1 = text(-0.4, -0.3, txt);%text(0.25,borderY2(1)+0.25,txt);
        t1.FontName = 'Gill Sans MT';
        t1.FontSize = 12;
        t1.Rotation = 90;
        ...
        %Plotting name text
        sbjFileName(5) = ' ';
        nameText = strcat(sbjFileName, ", ", trialType, ", Layout ", num2str(layoutNum), ", " ,directionality, ", top down");
        ...
        %Legend
        %Not necessary since we're not overlaying multiple paths
        ...
        filePath = strcat('../PosFigures/singlePath_Condition/', sbjFileName, "_", trialType, "_Layout", num2str(layoutNum), "_", directionality, "_TopDown");
